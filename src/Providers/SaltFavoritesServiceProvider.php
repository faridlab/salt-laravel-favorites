...
namespace SaltFavorites\Providers;

use Illuminate\Support\ServiceProvider;

class SaltFavoritesServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/salt-laravel-favorites.php' => config_path('salt-laravel-favorites.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-favorites');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-favorites');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-laravel-favorites'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-laravel-favorites');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-laravel-favorites'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltFavorites\Console\Commands\SaltFavoritesCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-laravel-favorites'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-laravel-favorites.php', 'salt-laravel-favorites'
        // );
    }
}
